...
- **Parser** (`parser/`) — persistent OpenDataLoader (Java) service with the reviewed native repairs and RapidOCR on text-less pages; one document at a time, a bounded queue.
