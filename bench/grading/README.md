...
[`model_artifacts.json`](fixtures/model_artifacts.json) records the six original file
...
```powershell
python bench/grading/scripts/build_corpus.py --require-complete
python bench/grading/scripts/benchmark.py validate bench/grading/fixtures/corpus.jsonl
python -m unittest discover -s bench/grading/scripts -p test_benchmark.py
node bench/grading/scripts/test_browser.mjs
python bench/grading/scripts/benchmark.py run --dataset bench/grading/fixtures/corpus.jsonl --output data/grading-benchmark/runs/core-native.jsonl --models gemma4-e2b-q4 bonsai-1.7b-q1 qwen3.5-2b-q4 engsaf-qwen2.5-1.5b-q4 bonsai-4b-q1 lfm2.5-1.2b-q4 --parallel 32 --shuffle-seed 20260905
python bench/grading/scripts/benchmark.py report data/grading-benchmark/runs/core-native.jsonl
python bench/grading/scripts/browser.py --dataset bench/grading/fixtures/browser-core.jsonl --output data/grading-benchmark/runs/core-browser-reproduction.jsonl --models gemma4-e2b-q4 qwen3.5-2b-q4 --shuffle-seed 20260905
```
...
```powershell
python bench/grading/scripts/compare_runtimes.py --native-dataset bench/grading/fixtures/corpus.jsonl --browser-dataset bench/grading/fixtures/browser-core.jsonl --native-input data/grading-benchmark/runs/core-native.jsonl --browser-input data/grading-benchmark/runs/core-browser.jsonl --models gemma4-e2b-q4 --output data/grading-benchmark/analysis/runtime-pairs.json
```
...
```powershell
python bench/grading/scripts/baseline.py --dataset bench/grading/fixtures/browser-core.jsonl --output data/grading-benchmark/runs/core-browser-literal.jsonl
python bench/grading/scripts/analyse.py compare --dataset bench/grading/fixtures/browser-core.jsonl --input data/grading-benchmark/runs/core-browser.jsonl data/grading-benchmark/runs/core-browser-literal.jsonl --models gemma4-e2b-q4 literal-point-baseline --output data/grading-benchmark/analysis/core-browser.json
```
...
```powershell
python bench/grading/scripts/browser.py --dataset bench/grading/fixtures/browser-core.jsonl --output data/grading-benchmark/runs/qwen-browser-reproduction.jsonl --models qwen3.5-2b-q4 --shuffle-seed 20260905
```
...
```powershell
python bench/grading/scripts/build_challenges.py --dataset bench/grading/fixtures/corpus.jsonl --output bench/grading/fixtures/challenges.jsonl --review bench/grading/fixtures/challenge_review.json
python bench/grading/scripts/benchmark.py run --dataset bench/grading/fixtures/challenges.jsonl --output data/grading-benchmark/runs/challenge-native.jsonl --models gemma4-e2b-q4 qwen3.5-2b-q4 --parallel 32 --shuffle-seed 20260905
```
...
```powershell
python bench/grading/scripts/baseline.py --dataset bench/grading/fixtures/corpus.jsonl --output data/grading-benchmark/runs/core-literal-final.jsonl
python bench/grading/scripts/analyse.py compare --dataset bench/grading/fixtures/corpus.jsonl --input data/grading-benchmark/runs/core-native.jsonl data/grading-benchmark/runs/core-literal-final.jsonl --models gemma4-e2b-q4 bonsai-1.7b-q1 qwen3.5-2b-q4 engsaf-qwen2.5-1.5b-q4 bonsai-4b-q1 lfm2.5-1.2b-q4 literal-point-baseline --output data/grading-benchmark/analysis/core-native.json
```
...
The small compatibility pilot is in [`PILOT_RESULTS.md`](reports/2026-09-05-pilot.md).
