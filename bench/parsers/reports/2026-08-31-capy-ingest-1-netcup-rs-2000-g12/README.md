...
[`../../netcup-2026-08-31-stress.md`](../2026-08-31-worker-stress.md).

The generated PDFs, 32 to 120 MiB content-list fixtures, parser bundles, Docker
images, and model cache remain on `capy-ingest-1`. The generated input and spool
...
`raw/` is a copy of `/opt/capy-ingest/stress-results/` from the VM. It contains
