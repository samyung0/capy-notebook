...
`raw/` is an exact copy of the VM's `/opt/capy-ingest/stress-results/` directory
...
| --------------------------------- | ----: | ------------: | ------------------------------------------------------------------------ |
| `/opt/capy-ingest/stress-current/` |    12 |   327,412,284 | Parser source snapshot and 32, 64, 96, and 120 MiB content-list fixtures |
| `/opt/capy-ingest/stress-spool/`   |   154 | 1,371,748,911 | Synthetic PDFs, immutable parser bundles, and overlap fixtures           |
...
| ---------------------------- | ------------------------------------------------------------------------- | ------------: |
| `capy-parser-stress:current`  | `sha256:f891c36a6ed55f165672f8ce1ca290a1d8f9af2650f04cbf0138a697e7572843` |        2.5 GB |
| `capy-worker-stress:current`  | `sha256:dc0c6af2a9d0c245ca9d5174b134a21e73518fea79a0acefabf34bf3a62cc81b` |        884 MB |
| `capy-current-parser:stress`  | `sha256:d0f0678ab869e1bb9819a911eefd9338433259f0702ae8c1ee1abf392fd788b5` |        2.5 GB |
| `capy-current-parser:stress8` | `sha256:b7f9a3aad60740d24657f716a4ae6583ec5df726d406de103348c93555aa2d89` |        2.5 GB |
