...
[`2026-08-31-capy-ingest-1-netcup-rs-2000-g12/`](2026-08-31-capy-ingest-1-netcup-rs-2000-g12/).
...
Docker is enabled at boot. At test time, `capy-ingest.service` was installed but
...
`/opt/capy-ingest/stress-results/`. The copied test source and generated scan are
under `/opt/capy-ingest/stress-current/` and `/opt/capy-ingest/stress-spool/`.
