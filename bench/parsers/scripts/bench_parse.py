...
which lane (digital vs ocr) each job took.
    ...
    python bench/parsers/scripts/bench_parse.py --file bench/parsers/fixtures/docs/metabolic_pathway.pdf
    python bench/parsers/scripts/bench_parse.py --jobs 8 --parse-method marker_only --file ...
    python bench/parsers/scripts/bench_parse.py --sweep 1,2,4,6,8 --parse-method marker_only --file ...
