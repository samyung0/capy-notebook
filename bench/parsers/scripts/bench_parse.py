...
which lane (digital vs ocr) each job took.
    ...
    python bench/parsers/scripts/bench_parse.py --jobs 8 --parse-method txt --file ...
    python bench/parsers/scripts/bench_parse.py --sweep 1,2,4,6,8 --parse-method ocr --file ...
