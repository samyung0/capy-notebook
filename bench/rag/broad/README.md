...
change from the [curated experiment](../curated/reports/2026-09-05-curated.md) on fresh public data.
It does not train a model or choose new settings from the evaluation results.
The [plan](reports/2026-09-05-broad-plan.md) fixes the comparison and scope.
