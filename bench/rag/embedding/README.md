...
Read [REPORT.md](reports/2026-09-06-embedding.md) for the results and [summary.json](reports/summary.json) for
the complete metrics. [answer-reviews.json](reports/answer-reviews.json) records the
source check of every curated answer under [review-protocol.md](reports/2026-09-06-review-protocol.md).

See [PLAN.md](reports/2026-09-06-embedding-plan.md) for the conditions and selection rule fixed before the
