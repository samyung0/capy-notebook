...
PROVIDER_KEYS = ("DEEPSEEK_API_KEY", "DEEPINFRA_API_KEY", "OPENAI_API_KEY", "ANTHROPIC_API_KEY", "TOKENHUB")
...
KNOWLEDGE_B2_KEYS = (
    "KNOWLEDGE_BASE_B2_ENDPOINT", "KNOWLEDGE_BASE_B2_REGION", "KNOWLEDGE_BASE_B2_BUCKET",
    "KNOWLEDGE_BASE_B2_KEY_ID", "KNOWLEDGE_BASE_B2_APP_KEY",
)
...
def prepare_environment(target: str) -> str:
    ...
    if not os.environ.get("LIBRARY_DATABASE_URL") and env.get("LIBRARY_DATABASE_URL"):
        ...
        os.environ["LIBRARY_DATABASE_URL"] = on_tunnel(env["LIBRARY_DATABASE_URL"], LIBRARY_PORT)
