...
- Stripe only until you decide otherwise. Test friends get Pro in the database. You watch the parser VM and B2. Policy credits and invoices are different numbers.
