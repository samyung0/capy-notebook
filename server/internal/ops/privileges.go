...
var readRequiredPrivileges = []columnPrivilege{
	...
	{"parse_host_samples", "sampled_at", "SELECT"},
	{"parse_host_samples", "host_id", "SELECT"},
	{"parse_host_samples", "active_jobs", "SELECT"},
	{"parse_host_samples", "queued_jobs", "SELECT"},
	{"parse_host_samples", "cpu_percent", "SELECT"},
	{"parse_host_samples", "load_1", "SELECT"},
	{"parse_host_samples", "memory_total_bytes", "SELECT"},
	{"parse_host_samples", "memory_used_bytes", "SELECT"},
	{"parse_host_samples", "swap_used_bytes", "SELECT"},
	{"parse_host_samples", "parser_memory_bytes", "SELECT"},
	{"parse_host_samples", "parser_pss_bytes", "SELECT"},
	{"parse_host_samples", "network_rx_bytes", "SELECT"},
	{"parse_host_samples", "network_tx_bytes", "SELECT"},
}
